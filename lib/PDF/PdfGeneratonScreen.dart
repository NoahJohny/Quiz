                ...
                children: [
                  ...
                  Form(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        MainScreenCard(ques: _ques, icon: widget.icon, max: 3, lable: "Number Of Questions", maxValue: 100),
                        MainScreenCard(ques: _range1, icon: widget.icon, max: 5, lable: "Start Value"),
                        MainScreenCard(ques: _range2, icon: widget.icon, max: 5, lable: "End Value"),
                      ],
                    ),
                  ),
                  SizedBox(height: 30),
